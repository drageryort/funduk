    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <button type="button" class="btn btn-default">Прикрепить файлы</button>
          <span class='infocontent'>Вы можете загрузить сколько угодно изображений в форматах *.jpg, *.png, размером файла до 5 МБ</span>
        </div>
      </div>
      `);
